...
public class AggregatedMetrics {
    ...
    public static final Counter STORAGE_BULK_COMMIT  = build("storage_bulk_commit", "Total bulk commits.");
    ...
    public static final Counter LOGIN_ADD_MOUNT  = build("login_add_mount", "Total add mount factor calls.");
    public static final Counter LOGIN_ENABLE_MOUNT  = build("login_enable_mount", "Total enable mount factor calls.");
