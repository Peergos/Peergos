...
import peergos.server.tests.linux.*;
...
import static peergos.server.tests.UserTests.*;

@RunWith(Parameterized.class)
public class MultiNodeS3Tests {
...
//    @Parameterized.Parameter()
    ...
    public MultiNodeS3Tests(int iNode1, int iNode2) {
        this.iNode1 = iNode1;
        this.iNode2 = iNode2;
    ...
    public static void init() throws Exception {
        ...
        // create two other nodes that use the first as a PKI-node and S3 blockstore
        for (int i = 0; i < 2; i++) {
            ...
            Args normalNode = S3UserTests.withS3(UserTests.buildArgs()
                    .with("useIPFS", "true")
