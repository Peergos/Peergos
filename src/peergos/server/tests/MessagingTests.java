...
public class MessagingTests {
    ...
    public void basicChat() {
        ...
        chat2.merge(chat1.host, stores.get(0), stores.get(1), ipfs, NO_OP).join();
        ...
        chat1.merge(chat2.host, stores.get(1), stores.get(0), ipfs, NO_OP).join();
    ...
    public void messagePropagation() {
        ...
        chat2.merge(chat3.host, stores.get(2), stores.get(1), ipfs, NO_OP).join();
    ...
    public void partitionAndJoin() {
        ...
        chat4.merge(chat3.host, stores.get(2), stores.get(3), ipfs, NO_OP).join();
        ...
        chat3.merge(chat4.host, stores.get(3), stores.get(2), ipfs, NO_OP).join();
        ...
        chat1.merge(chat4.host, stores.get(3), stores.get(0), ipfs, NO_OP).join();
