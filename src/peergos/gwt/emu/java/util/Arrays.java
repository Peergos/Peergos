...
public class Arrays {
    ...
    private static <T> T copyPrimitiveArray(T original, T copy, int from, int to) {
        ...
        nativecopy(original, from, copy, 0, copyLen);
        return copy;
    }

    @JsMethod(name = "arraycopy", namespace = "arrayutils")
    public static native void nativecopy(Object src, int srcOfs, Object dest, int destOfs, int len);
