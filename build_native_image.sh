...
$NATIVE_IMAGE_BIN -H:EnableURLProtocols=http -H:+ReportUnsupportedElementsAtRuntime --no-server --no-fallback --initialize-at-build-time=org.sqlite.JDBC,org.sqlite.DB,org.sqlite.NativeDB -jar "$PEERGOS_JAR_PATH" peergos
