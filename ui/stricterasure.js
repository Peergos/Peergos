...
{
    const out = message.subarray(0, message.length);
...
var Erase = function() {
    ...
    this.split = function(ints, originalBlobs, allowedFailures)
    {
        ...
        {
            const copy = ints.subarray(i, i + inputSize);
