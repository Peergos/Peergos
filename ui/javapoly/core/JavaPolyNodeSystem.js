...
var _NodeSystemDispatcher = require('../dispatcher/NodeSystemDispatcher.js');

var _NodeSystemDispatcher2 = _interopRequireDefault(_NodeSystemDispatcher);
...
var DEFAULT_JAVAPOLY_NODE_SYSTEM_OPTIONS = {
  javapolyBase: '',
...
var JavaPoly = function (_JavaPolyBase) {
  ...
  function JavaPoly(_options) {
    ...
    var options = _.extend(DEFAULT_JAVAPOLY_NODE_SYSTEM_OPTIONS, _options);
  ...
  _createClass(JavaPoly, [{
    ...
    value: function beginLoading(resolveDispatcherReady) {
      this.dispatcher = new _NodeSystemDispatcher2.default(this);
